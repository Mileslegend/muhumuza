...
export const services = [
  {
    name:"UI/UX Design",
    icon:<FaPaintBrush/>,
    description:`Prepare to be captivated by my unparalleled prowess in UI/UX design,
     expertly harnessed through the mighty Figma.
    I weave pixel-perfect creations that redefine digital experiences,
     leaving a lasting impact on all who engage`,
  },
  {
    name:"Web Development",
    icon:<FaLaptopCode/>,
    description:`I seamlessly blend code and creativity into digital masterpieces.
     With a deep command over HTML, CSS, and JavaScript, I bring life to static websites, 
     transforming them into dynamic and engaging online experiences.
      From sleek front-end designs to powerful back-end functionality,
     I craft virtual realms that captivate and delight users.`,
  },
  {
    name:"Content Creation",
    icon:<TfiWrite/>,
    description:`As a seasoned content creator, 
    I possess the rare ability to craft compelling narratives that resonate with audiences 
    far and wide. With a keen eye for detail and a knack for storytelling,
     I breathe life into words,
     creating captivating articles, blog posts, and social media content.`,
  },
...
export const projects = [
  { 
    ...
    description: `Transforming education with AI, our School UI Design project revolutionizes the 
                     ...
                     journey.`,
    demoLink: "https://muhuandevelopers.netlify.app/",
    stack:[
      {
        name:"XD",
        icon: <SiAdobexd/>,
  ...
  },
  {
    ...
    demoLink: "https://protector-nu.vercel.app/",
    stack:[
      {
        name:"Figma",
        icon: <CgFigma/>,
...
export const socialHandles = [
    {
      name:"Instagram",
      icon:<FaInstagram />,
      link:"https://www.instagram.com/mileslegend3/",
    },
    {
      name:"Facebook",
      icon:<FaFacebookSquare/>,
      link:"https://www.facebook.com/prince.allan.5243/",
    },
    {
      name:"Twitter",
      icon:<FaXTwitter/>,
      link:"https://x.com/Mileslegend1",
    },
    {
      name:"Youtube",
      icon:<FaYoutube/>,
      link:"https://www.youtube.com/@mileslegend",
    },
];
